...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/activesupport-2.3.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/actionmailer-2.3.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_appengine-0.0.4/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.1.0/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rack-1.1.0/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/actionpack-2.3.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jruby-openssl-0.7/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/tiny_ds-0.0.2/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/activerecord-2.3.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/activeresource-2.3.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails-2.3.8/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails-2.3.8/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/rails_tiny_ds-0.0.2.1/lib")
